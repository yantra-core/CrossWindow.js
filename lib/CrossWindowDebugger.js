...
export default class CrossWindowDebugger {
  constructor(crossWindowInstance, options = {}) {
    ...
    let flags = [
      ...
      'showExampleBarContainer'
    ];

    // set all flags default true
    flags.forEach(flag => {
      this[flag] = true;
      // check type of option to set flags
  ...
  initUI() {
    ...
    // Examples bar
    //
    if (this.showExampleBarContainer) {
  ...
  createExamplesBar() {
    ...
    Object.assign(buttonBarContainer.style, {
      position: 'absolute',
      top: '10px', // Position at the bottom of the viewport
      left: '50%',
    ...
    this.buttonConfigs = this.buttonConfigs || [
      ...
      { label: 'Keyboard Typer', url: 'https://yantra.gg/crosswindow/keyboard-typer' },
      { label: 'Piano', url: 'https://yantra.gg/crosswindow/piano' },
      { label: 'Debugger', url: 'https://yantra.gg/crosswindow/simple' },
